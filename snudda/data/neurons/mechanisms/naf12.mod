...
PROCEDURE rates() {
    UNITSOFF
    minf = 1/(1+exp((v-(-17.1516))/(-8.029)))
    mtau = 0.1+1/(exp((v-(-45))/15)+exp((v-(-43))/(-17)))
    hinf = 1/(1+exp((v-(-42.67232958))/8.6577))
    htau = 0.31+1/(exp((v-(-22.9))/8.167812)+exp((v-(-45))/(-10)))
...
Updated to match data from Oliva et al., 2014. Mouse Nav1.2 WT, room temperature. WST 2024.
