...
class Snudda(object):
    ...
    def simulate(self,
        ...
        if 'CC' in str(self.network_path):
            ...
            # sim.add_current_injection(neuron_id = neuron_id, start_time=0, end_time= 3.0, amplitude=-0.09*1e-9)
            sim.add_current_injection(neuron_id = neuron_id, start_time=0, end_time= 3.0, amplitude='lookup')
