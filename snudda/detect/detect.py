...
class SnuddaDetect(object):
    ...
    def get_density_location(self, neuron, n_id,  seed):
        ...
        if neuron.axon_density_type == "r":
            ...
            return self.hyper_voxel_targets[n_id]
    ...
    def get_hyper_voxel_axon_points_new_sparse(self, targets): #, prox_dist = 100):
        ...
        selected_targets = np.random.choice(put_targets, size = min(3, len(put_targets)), replace = False)
    ...
    def no_axon_points_new_sparse(self, targets): 
    ...
    def distribute_neurons_parallel(self, d_view=None):
        ...
        if d_view is None:
            ...
            # self.soma_voxel_id = list({k for k, v in self.hyper_voxels.items() 
            #                       if 'neurons' in v and 
